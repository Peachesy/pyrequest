...
class AddEventTest(unittest.TestCase):
    ...
    def test_add_event_sign_null(self):
        '''签名参数为空'''
        payload = {'eid':5,'':'','limit':'','address':'','start_time':'','time':'','sign':''}
    ...
    def test_add_event_time_out(self):
        ...
        payload = {'eid':5,'':'','limit':'','address':'','start_time':'','time':'now_time','sign':'abc'}
        r = requests.post(self.base_url, data=payload)
        result = r.json()
    ...
    def test_add_event_sign_error(self):
        '''签名错误'''
        payload = {'eid': 5, '': '', 'limit': '', 'address': '', 'start_time': '', 'time': 'self.client_time', 'sign': 'abc'}
        r = requests.post(self.base_url, data=payload)
        result = r.json()
